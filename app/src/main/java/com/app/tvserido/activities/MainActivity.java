...
import static com.app.tvserido.utils.Constant.BANNER_AD;
import static com.app.tvserido.utils.Constant.INTERSTITIAL_AD;
import static com.app.tvserido.utils.Constant.NATIVE_AD;
...
import com.app.tvserido.Config;
import com.app.tvserido.R;
import com.app.tvserido.database.dao.AppDatabase;
import com.app.tvserido.database.dao.DAO;
import com.app.tvserido.database.dao.RadioEntity;
import com.app.tvserido.database.prefs.AdsPref;
import com.app.tvserido.database.prefs.SharedPref;
import com.app.tvserido.fragments.FragmentRadio;
import com.app.tvserido.fragments.FragmentSocial;
import com.app.tvserido.fragments.FragmentWebView;
import com.app.tvserido.models.Radio;
import com.app.tvserido.services.RadioPlayerService;
import com.app.tvserido.utils.AdsManager;
import com.app.tvserido.utils.Constant;
import com.app.tvserido.utils.RelativePopupWindow;
import com.app.tvserido.utils.SleepTimeReceiver;
    ...
    public void changeText(Radio radio) {
        ...
        if (sharedPref.getBlurRadioBackground().equals("true")) {
            Glide.with(getApplicationContext())
                    .asBitmap()
                    .load(radio.getBackground_image_url().replace(" ", "%10"))
